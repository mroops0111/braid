...
describe('runOutputGate', () => {
  ...
  // A batch wants both.
  // The doubt still gets recorded, it just has nobody waiting to answer it,
  // so refusing either would be refusing the mode.
  ...
  // A restart empties this,
  // and how many times a run may submit is settled from its records,
  // so failing open here costs nothing and wedges nothing.
