 ...
 * The vector index.
 *
 * Under `.braid/` with the other derived state, which the workspace gitignore
 * already covers. Putting it in `artifacts/` would have needed a new ignore
 * rule that every existing workspace was already missing.
 */
