 ...
 * Separate from the repository because the hashing strategy is
 * loader-specific: a filesystem source walks the directory; an MCP
 * source might delegate to the server's etag; etc.
 */
