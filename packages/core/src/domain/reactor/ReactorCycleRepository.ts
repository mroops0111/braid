 ...
 *
 * Sorted by `startedAt` descending in `listByWorkspace` so the Activity list always shows the newest pass first.
 * `save` is upsert, same pass id written multiple times overwrites in place,
