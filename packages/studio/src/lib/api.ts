...
/** A skill with why it cannot run here, beside the files that would not load at all. */
export type SkillListItem = SkillManifest & { readiness: SkillReadinessIssue[] }
