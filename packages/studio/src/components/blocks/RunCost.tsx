 ...
 *
 * Kept out of the heading because it is not what anybody came to read.
 * It belongs to the log, so it sits at the end of the log,
 * where somebody checking a run's expense already is.
 */
