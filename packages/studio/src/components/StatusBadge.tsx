...
const STATUS_STYLES: Record<string, { badge: string, dot: string }> = {
  ...
  // Drift severities, so a conflict is graded in the same vocabulary the rest
  // of Studio grades everything else in.
...
/**
 * The tint a status carries, for the places that need the colour without the
 * badge around it. Read from the one record so a dot and a badge for the same
 * status can never come to disagree.
 */
